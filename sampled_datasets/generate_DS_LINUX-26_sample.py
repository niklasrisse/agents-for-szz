#!/usr/bin/env python3
"""Generate a random sample from the Linux Data Leakage dataset.

This script samples entries from the DS-LINUX-26 dataset
...
# Paths
DATA_FILE = PROJECT_ROOT / "data/DS_LINUX-26.json"
...
def main():
    ...
    output_file = OUTPUT_DIR / f"DS_LINUX-26_{len(sample)}_{RANDOM_SEED}.json"
